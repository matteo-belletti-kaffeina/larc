...
// Current version
if ( ! defined( 'TRX_ADDONS_VERSION' ) ) define( 'TRX_ADDONS_VERSION', '1.6.3' );
...
if ( !function_exists('trx_addons_init') ) {
	...
	function trx_addons_init() {
		...
		$thumb_sizes = apply_filters('trx_addons_filter_add_thumb_sizes', array(
			...
			'trx_addons-thumb-team-default'	=> array(285, 320, true),
			'trx_addons-thumb-medium'		=> array(370, 208, true),
			'trx_addons-thumb-blogger'		=> array(500, 390, true),
			'trx_addons-thumb-small'		=> array(270, 152, true),
			'trx_addons-thumb-portrait'		=> array(370, 493, true),
			'trx_addons-thumb-services4'	=> array(370, 270, true),
			'trx_addons-thumb-services5'	=> array(400, 359, true),
...
if ( !function_exists('trx_addons_image_sizes') ) {
	...
	function trx_addons_image_sizes( $sizes ) {
		$thumb_sizes = apply_filters('trx_addons_filter_add_thumb_sizes', array(
			...
			'trx_addons-thumb-team-default'		=> esc_html__( 'Team Default', 'trx_addons' ),
			'trx_addons-thumb-med'		=> esc_html__( 'Medium image', 'trx_addons' ),
			'trx_addons-thumb-blogger'	=> esc_html__( 'Blogger image', 'trx_addons' ),
			'trx_addons-thumb-small'	=> esc_html__( 'Small image', 'trx_addons' ),
			'trx_addons-thumb-portrait'	=> esc_html__( 'Portrait', 'trx_addons' ),
			'trx_addons-thumb-services4'=> esc_html__( 'Services default 4', 'trx_addons' ),
			'trx_addons-thumb-services5'=> esc_html__( 'Services default 5', 'trx_addons' ),
