...
if ($query->found_posts > 0) {
	...
	$services_main_class = (substr($args['type'],0,-1) == 'default' ? 'sc_services_default' : 'sc_services_light');
	?><div<?php if (!empty($args['id'])) echo ' id="'.esc_attr($args['id']).'"'; ?> class="sc_services <?php echo esc_attr($services_main_class); ?> sc_services_<?php 
