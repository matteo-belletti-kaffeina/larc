...
?><div id="post-<?php the_ID(); ?>"	<?php post_class( 'sc_blogger_item post_format_'.esc_attr($post_format) ); ?>> ciaoo<?php
	...
	?><div class="sc_blogger_item_content entry-content"><?php
		...
		if (!isset($args['hide_excerpt']) || $args['hide_excerpt']==0) {
			?><div class="sc_blogger_item_excerpt">
				...
				// More button
				if ( $show_more ) {
					?><div id="mostraTutti" class="sc_blogger_item_button sc_item_button"><a href="<?php echo esc_url($post_link); ?>" class="sc_button sc_button_simple"><?php esc_html_e('Read more', 'luxmed'); ?></a></div><?php
				}
