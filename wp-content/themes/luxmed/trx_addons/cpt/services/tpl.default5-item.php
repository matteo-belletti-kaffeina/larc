<?php
/**
 * The style "default5" of the Services
 *
 * @package WordPress
...
?>">
	...
	if ( has_post_thumbnail() && (empty($args['featured']) || $args['featured']=='image')) {
		trx_addons_get_template_part('templates/tpl.featured.php',
										...
										apply_filters('trx_addons_filter_args_featured', array(
														...
														'thumb_size' => apply_filters('trx_addons_filter_thumb_size', trx_addons_get_thumb_size($args['columns'] > 2 ? 'masonry' : 'avatar'), 'services-light')
														),
														'services-light'
														)
									);
	...
	<?php 
		...
		<div class="sc_services_item_header">
			<?php
			$title_tag = $args['featured']=='number' ? 'h5' : 'h5';
			?>
