...
if (!function_exists('luxmed_trx_addons_get_css')) {
	add_filter('luxmed_filter_get_css', 'luxmed_trx_addons_get_css', 10, 4);
	function luxmed_trx_addons_get_css($css, $colors, $fonts, $scheme='') {
...
.scheme_self.footer_wrap .sc_layouts_row_type_compact,
...
.sc_layouts_item .mini_cart_item a {
	color: {$colors['text_dark']} !important;
}
.sc_layouts_item .mini_cart_item a:hover {
...
.sc_layouts_logo:hover .logo_slogan {
	color: {$colors['accent2']};
}
...
.search_style_fullscreen.search_opened .search_field {
	border-bottom-color: {$colors['input_light']} !important;
}
.search_style_fullscreen.search_opened .search_field:focus {
	border-bottom-color: {$colors['input_text']} !important;
}
...
.sc_layouts_row_type_narrow.scheme_self .sc_layouts_menu_nav > li > a:hover,
.sc_layouts_row_type_narrow .sc_layouts_menu_nav > li > a:hover,
.sc_layouts_row_type_narrow.scheme_self .sc_layouts_menu_nav > li.sfHover > a,
.sc_layouts_row_type_narrow .sc_layouts_menu_nav > li.sfHover > a,
.sc_layouts_row_type_narrow.scheme_self .sc_layouts_menu_nav > li.current-menu-item > a,
.sc_layouts_row_type_narrow .sc_layouts_menu_nav > li.current-menu-item > a,
.sc_layouts_row_type_narrow.scheme_self .sc_layouts_menu_nav > li.current-menu-parent > a,
.sc_layouts_row_type_narrow .sc_layouts_menu_nav > li.current-menu-parent > a,
.sc_layouts_row_type_narrow.scheme_self .sc_layouts_menu_nav > li.current-menu-ancestor > a,
...
.trx_addons_hover_title a {
	color: {$colors['text']};
}
.trx_addons_hover_title a:hover {
	color: {$colors['text_link']};
}
...
.slider_swiper_outer .swiper-pagination-bullet {
	background-color: {$colors['text_light_05']};
}
...
.slider_swiper_outer .slider_pagination_wrap .swiper-pagination-bullet:hover {
	background-color: {$colors['accent2']};
	-webkit-box-shadow: 0 0 0 1px {$colors['accent2']};
	-moz-box-shadow: 0 0 0 1px {$colors['accent2']};
	box-shadow: 0 0 0 1px {$colors['accent2']};
}
...
.sc_title_mono .sc_item_subtitle {
...
.sc_icons_modern [class*="trx_addons_column-"]:nth-child(2n) .sc_icons_item,
.sc_icons_alter [class*="trx_addons_column-"]:nth-child(2n) .sc_icons_item {
	background-color: {$colors['accent2']};
}
.sc_icons_modern [class*="trx_addons_column-"]:nth-child(2n) .sc_icons_item,
.sc_icons_alter [class*="trx_addons_column-"]:nth-child(2n) .sc_icons_item {
...
.sc_icons_alter [class*="trx_addons_column-"]:nth-child(2n) .sc_icons_icon {
	background-color: transparent;
	border-color: {$colors['inverse_link']};
}
.sc_icons_modern [class*="trx_addons_column-"]:nth-child(2n) .sc_icons_icon,
.sc_icons_modern [class*="trx_addons_column-"]:nth-child(2n) .sc_icons_item_description,
.sc_icons_modern [class*="trx_addons_column-"]:nth-child(2n) .sc_icons_item_title,
.sc_icons_alter [class*="trx_addons_column-"]:nth-child(2n) .sc_icons_icon,
.sc_icons_alter [class*="trx_addons_column-"]:nth-child(2n) .sc_icons_item_description,
.sc_icons_alter [class*="trx_addons_column-"]:nth-child(2n) .sc_icons_item_title {
	color: {$colors['inverse_link']};
}
...
.lbg .sc_promo_modern .sc_promo_link2 {
...
.scheme_self.sc_promo_modern .sc_promo_descr {
	color: {$colors['text']};
}
...
.sc_content .sc_services_default1 .sc_services_item {
	background-color: {$colors['bg_color']};
}
.sc_services_default1 .sc_services_item a,
.sc_services_default1 .sc_services_item a:hover,
.sc_services_default1 .sc_services_item_icon,
.sc_services_default1 .sc_services_item_icon:hover {
		color: {$colors['text_dark']};
}
.sc_services_default1 .sc_services_item a:after {
		background-color: {$colors['text_light']};
}
.sc_services_default1 .sc_services_item_featured_right:hover .sc_services_item_icon,
.sc_services_default1 .sc_services_item_featured_left:hover .sc_services_item_icon {
	background-color: transparent;
}
.sc_services_default1 div[class*="trx_addons_column-"]:nth-child(3n-1) .sc_services_item {
	background-color: {$colors['text_link']};
}
.sc_services_default1 div[class*="trx_addons_column-"]:nth-child(3n) .sc_services_item {
	background-color: {$colors['accent2']};
}
.sc_services_default1 div[class*="trx_addons_column-"]:nth-child(3n) .sc_services_item *,
.sc_services_default1 div[class*="trx_addons_column-"]:nth-child(3n-1) .sc_services_item * {
...
.sc_services_default1 div[class*="trx_addons_column-"]:nth-child(3n) .sc_services_item a:after,
.sc_services_default1 div[class*="trx_addons_column-"]:nth-child(3n-1) .sc_services_item a:after {
...
.sc_services_default2 div[class*="trx_addons_column-1"]:nth-child(2n) .sc_services_item {
	background-color: {$colors['alter_bg_color']};
}
.sc_services_default2 div[class*="trx_addons_column-1"]:nth-child(3n) .sc_services_item {
	background-color: {$colors['text_link']};
}
.sc_services_default2 div[class*="trx_addons_column-1"]:nth-child(4n) .sc_services_item {
	background-color: {$colors['accent2']};
}
.sc_services_default2 .sc_services_item_icon {
	color: {$colors['text_hover']};
}
.sc_services_default2 .sc_services_item_subtitle a {
	color: {$colors['text_light']};
}
.sc_services_default2 .sc_services_item_subtitle a:hover,
.sc_services_default2 .sc_services_item_icon:hover {
	color: {$colors['text_link']};
}
.sc_services_default2 .sc_services_item_icon:hover {
	color: {$colors['text_link']};
}
.sc_services_default2 div[class*="trx_addons_column-1"]:nth-child(3n) *,
.sc_services_default2 div[class*="trx_addons_column-1"]:nth-child(4n) * {
	color: {$colors['inverse_link']};
}
...
.sc_services_default3 .sc_services_columns + .sc_layouts_item .sc_button:hover,
.sc_services_default3 .sc_services_columns + .sc_button:hover {
	background-color: {$colors['alter_hover_blend']} !important;
}
...
.sc_services_light1 .sc_services_columns + .sc_layouts_item .sc_button {
	background-color: {$colors['accent2']};
}
.sc_services_light1 .sc_services_columns + .sc_layouts_item .sc_button:hover {
	background-color: {$colors['accent2_blend']};
}
.sc_services_light1 .sc_services_item:hover .sc_services_item_icon {
	color: {$colors['accent2']};
}
...
.sc_services_light2 .sc_services_item:hover .sc_services_item_icon {
	background-color: {$colors['inverse_link']};
	color: {$colors['text_link']};
}
.sc_services_light3 .sc_services_item_subtitle a,
.sc_services_light2 .sc_services_item_subtitle a {
	color: {$colors['text_light']};
}
.sc_services_light3 .sc_services_item_subtitle a:hover,
.sc_services_light2 .sc_services_item_subtitle a:hover {
	color: {$colors['text_link']};
}
.sc_services_default4 .sc_button {
	background-color: {$colors['accent2']} !important;
}
.sc_services_default4 .sc_button:hover {
	background-color: {$colors['accent2_blend']} !important;
}
.sc_services_default5 .sc_services_item_title a:after,
.sc_services_default4 .sc_services_item_icon,
.sc_services_default4 .sc_services_item {
	background-color: {$colors['bg_color']};
}
.sc_services_default5  .sc_services_item {
	background-color: {$colors['accent2']};
}
.sc_services_default5  .sc_services_item * {
	color: {$colors['inverse_link']};
}
.sc_services_default5 [class*="trx_addons_column-"]:nth-child(2) .sc_services_item {
	background-color: {$colors['text_link']};
}
...
.sc_socials_alter .socials_wrap .social_item a,
.sc_socials_alter .socials_wrap .social_item a i {
	color: {$colors['text_dark']};
}
.sc_socials_alter .socials_wrap .social_item a:hover {
	background-color: transparent;
}
.sc_socials_alter .socials_wrap .social_item a:hover,
.sc_socials_alter .socials_wrap .social_item a:hover i {
	color: {$colors['inverse_hover']};
}
...
.sc_testimonials_alter .sc_testimonials_item {
	background-color: {$colors['bg_color']};
}
/* Team */
...
.sc_team_default .sc_layouts_item .sc_button:hover,
.sc_team_default > .sc_button:hover {
	background-color: {$colors['accent2_blend']} !important;
}
...
.sc_team_featured .sc_team_item_socials a:hover {
	border-color: {$colors['text_link']};
	color: {$colors['text_link']};
}
