...
if ( !function_exists( 'luxmed_woocommerce_get_css' ) ) {
	add_filter( 'luxmed_filter_get_css', 'luxmed_woocommerce_get_css', 10, 4 );
	function luxmed_woocommerce_get_css($css, $colors, $fonts, $scheme='') {
...
.woocommerce .add_to_wishlist.button:hover,
...
/* Buttons */
.luxmed_shop_mode_buttons a {
	color: {$colors['text_dark']};
}
.luxmed_shop_mode_buttons .woocommerce_list {
	color: {$colors['bd_color']};
}
.luxmed_shop_mode_buttons a:hover {
	color: {$colors['text_link']};
}
...
.single-product div.product .trx-stretch-width .woocommerce-tabs .panel input[type="email"],
.single-product div.product .trx-stretch-width .woocommerce-tabs .panel input[type="text"],
